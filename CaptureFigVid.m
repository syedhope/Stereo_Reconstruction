...
%  The below code has been taken from http://www.mathworks.com/matlabcentral/fileexchange/41093-create-video-of-rotating-3d-plot/content/CaptureFigVid/CaptureFigVid.m
%  And was submitted by Alan Jennings.
 %=========================================================================
 % The code has bee used to capture a video of the outputs for assignment 4 
 % in CAP 6419
 %=========================================================================
